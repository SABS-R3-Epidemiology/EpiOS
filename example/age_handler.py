...
df.loc[df['age_group'] < 16, 'age_group'] = df['age_group'][df['age_group'] < 16].apply(lambda x: x * 5 + np.random.randint(0, 5))
df.loc[df['age_group'] == 16, 'age_group'] = df['age_group'][df['age_group'] == 16].apply(lambda x: x * 5 + np.random.randint(0, 20))
